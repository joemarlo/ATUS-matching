...
create_industries <- function(url_CDC, NAICS_2017, Census_2012_changes){
  ...
  #                                          col_types = 'text')
  Census_2017$Census_2017 <- as.character(Census_2017$Census_2017)
  Census_2012_changes$Census_2017 <- as.character(Census_2012_changes$Census_2017)
  Census_to_NAICS <- dplyr::left_join(Census_2017, Census_2012_changes, by = 'Census_2017') %>% 
    mutate(Census_2012 = ifelse(is.na(Census_2012), Census_2017, Census_2012))
