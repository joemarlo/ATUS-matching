...
# Data dictionary
  ...
  - `fam_income` = family income: combined income of all family members during last 12 months. "Includes money from jobs, net income from business, farm or rent, pensions, dividends, interest, Social Security payments, and any other money income recevied by family members who are 15 years of age or older" 
  - `married` = married and spouse is present
  - `race`:
    - white = white only
    - black = black only
    - asian = asian only
